...
.then(rust_module => {
  ...
  const primary_slider = document.getElementById("primary-input");
  ...
  const fm_freq = document.getElementById("fm-freq");
  ...
  const fm_amount = document.getElementById("fm-amount");
